...
CREATE TABLE STOCK (
    ...
    CANTIDAD_DEPOSITO INT NOT NULL DEFAULT 0,
    CANTIDAD_SUCURSAL INT NOT NULL DEFAULT 0,
...
INSERT INTO USUARIOS (NOMBRE_COMPLETO, MAIL, CONTRASEÑA, ROL) VALUES ('Julian', 'julian@gmail.com', '$2b$10$pI/dOR6c/kEa/hYJqf5W9utr3ud3qRMEzjCTHuCfa0Wi9HqpvwOXS', 'ADMIN');
INSERT INTO USUARIOS (NOMBRE_COMPLETO, MAIL, CONTRASEÑA, ROL) VALUES ('Iara', 'iara@gmail.com', '$2b$10$pI/dOR6c/kEa/hYJqf5W9utr3ud3qRMEzjCTHuCfa0Wi9HqpvwOXS', 'EMPLEADO');
INSERT INTO USUARIOS (NOMBRE_COMPLETO, MAIL, CONTRASEÑA, ROL) VALUES ('Carlos', 'empleado@gmail.com', '$2b$10$pI/dOR6c/kEa/hYJqf5W9utr3ud3qRMEzjCTHuCfa0Wi9HqpvwOXS', 'EMPLEADO');
...
INSERT INTO PRODUCTOS (NOMBRE, DESCRIPCION, CATEGORIA, PRECIO, ACTIVE) VALUES ('LAYS', 'PAPAS FRITAS CLASICAS', 'SNACKS', '80',0)
...
INSERT INTO STOCK (ID_PRODUCTO, CANTIDAD_DEPOSITO, CANTIDAD_SUCURSAL) VALUES (12, 120, 0);
...
-- INSERTS DE EJEMPLO PARA LA TABLA CIERRE_CAJA (Cierres realizados por distintos empleados)

INSERT INTO CIERRE_CAJA (ID_EMPLEADO, FECHA_APERTURA, FECHA_CIERRE, MONTO_FINAL)
VALUES (6, DATEADD(DAY, -3, GETDATE()), DATEADD(DAY, -3, DATEADD(HOUR, 8, GETDATE())), 7500.50);
INSERT INTO CIERRE_CAJA (ID_EMPLEADO, FECHA_APERTURA, FECHA_CIERRE, MONTO_FINAL)
VALUES (6, DATEADD(DAY, -2, GETDATE()), DATEADD(DAY, -2, DATEADD(HOUR, 9, GETDATE())), 9800.75);
INSERT INTO CIERRE_CAJA (ID_EMPLEADO, FECHA_APERTURA, FECHA_CIERRE, MONTO_FINAL)
VALUES (6, DATEADD(DAY, -1, GETDATE()), DATEADD(DAY, -1, DATEADD(HOUR, 8, GETDATE())), 11250.00);
INSERT INTO CIERRE_CAJA (ID_EMPLEADO, FECHA_APERTURA, FECHA_CIERRE, MONTO_FINAL)
VALUES (6, DATEADD(HOUR, -9, GETDATE()), GETDATE(), 8750.25);
INSERT INTO CIERRE_CAJA (ID_EMPLEADO, FECHA_APERTURA, FECHA_CIERRE, MONTO_FINAL)
VALUES (5, DATEADD(DAY, -7, GETDATE()), DATEADD(DAY, -7, DATEADD(HOUR, 10, GETDATE())), 15000.00);
INSERT INTO CIERRE_CAJA (ID_EMPLEADO, FECHA_APERTURA, FECHA_CIERRE, MONTO_FINAL)
VALUES (5, DATEADD(DAY, -4, GETDATE()), DATEADD(DAY, -4, DATEADD(HOUR, 8, GETDATE())), 13450.80);
INSERT INTO CIERRE_CAJA (ID_EMPLEADO, FECHA_APERTURA, FECHA_CIERRE, MONTO_FINAL)
VALUES (6, GETDATE(), NULL, NULL);
GO